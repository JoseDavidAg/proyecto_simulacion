 ...
 * @author ambro
 */
public class Grafica_datos_daño_ambiental extends javax.swing.JFrame {

    /**
     * Creates new form Principal
     */
    public Grafica_datos_daño_ambiental() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Daño Ambiental para Esperanza de Vida");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Grafica_datos_daño_ambiental().setVisible(true);
            }
        });
    }
