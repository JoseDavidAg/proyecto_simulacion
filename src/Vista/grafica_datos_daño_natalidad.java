 ...
 * @author ambro
 */
public class Grafica_datos_daño_natalidad extends javax.swing.JFrame {

    /**
     * Creates new form Principal
     */
    public Grafica_datos_daño_natalidad() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Daño Ambiental a la Natalidad");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Grafica_datos_daño_natalidad().setVisible(true);
            }
        });
    }
